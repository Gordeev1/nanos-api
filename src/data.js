		...
		platforms: {
			facebook: {
				...
				target_audiance: {
					...
					genders: ['M', 'F'],
					age_range: [20, 66],
					locations: ['France', 'Germany', 'Switzerland'],
					interests: [
						'Docker',
						'Kubernates',
						'DevOps',
				...
				creatives: {
					...
					description:
						'DOP SuperHero is where all DevOps is going to happen in the future, join the revolution today!',
		...
		platforms: {
			...
			instagram: {
				...
				creatives: {
					header: 'Tired of doing DevOps ?',
					description:
						'Let us our smart AI DevOps Assistant help you #AWS #GCP #DevOps #Docker #Kubernates',
					url: 'https://example.io',
					image: 'img3.jpg',
				},
				insights: {
		...
		platforms: {
			...
			instagram: {
				...
				creatives: {
					header: 'Need Help?',
					description:
						'Let us take care of your frontend needs today! #Angular #React #React_native #VueJS #VueIsAwesome, #ReactForever #ILoveAngular #Frontend #Javascript',
					url: 'https://example.io',
					image: 'img4.jpg',
				},
				insights: {
